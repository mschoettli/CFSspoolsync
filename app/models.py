...
class Spool(Base):
    ...
    last_gross_weight_g = Column(Float, nullable=True)
    calibration_factor = Column(Float, nullable=True)
    calibrated_at = Column(DateTime, nullable=True)
    last_raw_k2_g = Column(Float, nullable=True)
    last_raw_remain_len = Column(Float, nullable=True)
    last_normalized_remain_len = Column(Float, nullable=True)
    last_weight_source = Column(String, nullable=True)
    last_weight_updated_at = Column(DateTime, nullable=True)
